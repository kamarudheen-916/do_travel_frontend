...
import { AdminDeletePostAPI } from '../../../API_admin/adminAPI';

const AdminPostCard: React.FC<userPost & {closeModal?:React.Dispatch<React.SetStateAction<boolean>>,isDeletedPost:boolean} > = (props) => {
  ...
  const handleDeletePost = async()=>{
    try {
        const res = await AdminDeletePostAPI(props._id) 
        if(res?.data.success){
          if(props.closeModal){
          ...
          <div className="topDiv flex justify-between items-center mt-5 mb-3">
           ...
           <div className='flex gap-5  '>
                ...
                <div className='font-extrabold '>
                 {!props.isDeletedPost && <p className='text-gray-200 hover:scale-x-95 cursor-pointer' onClick={handleDeletePost}>Delete</p>}
                 {/* <div>
