          ...
          <div className='uploadDiv'>
              ...
              {!fileUrl &&
                  <div className='uploadUserFile'>
                      ...
                      <input type='file' onChange={handleFileURL} id='uploadUserFile' />
                      <label style={{ marginTop: '100px' }} htmlFor='uploadUserFile' id='uploadUserFile_label'>Select from computer</label>
                  </div>
              }
          </div>
            { isNext &&  
            <div className='captionDiv'>
              ...
              <div >
                ...
                className='textArea_userCreate p-2  ' 
                ...
                <div className='flex justify-between '>
                 ...
                 {isEmojiOpen &&
                   <div className='fixed top-80 h-52 mt-5'>
                   <Picker data={data} 
                    maxFrequentRows={0} 
              ...
              <div>
                <button onClick={handleUserShare} className='ShareButton'>Share</button>
              </div>
          </div>}
        </div>
